...
Hᴇʟᴘ Sᴇᴄᴛɪᴏɴ:
    
/ɢᴜᴇss: Tᴏ Gᴜᴇss ᴄʜᴀʀᴀᴄᴛᴇʀ (ᴏɴʟʏ ᴡᴏʀᴋs ɪɴ ɢʀᴏᴜᴘ)
/ғᴀᴠ: Aᴅᴅ Yᴏᴜʀ ғᴀᴠ
/ᴛʀᴀᴅᴇ : Tᴏ ᴛʀᴀᴅᴇ Cʜᴀʀᴀᴄᴛᴇʀs
/ɢɪғᴛ: Gɪᴠᴇ ᴀɴʏ Cʜᴀʀᴀᴄᴛᴇʀ ғʀᴏᴍ Yᴏᴜʀ Cᴏʟʟᴇᴄᴛɪᴏɴ ᴛᴏ ᴀɴᴏᴛʜᴇʀ ᴜsᴇʀ.. (ᴏɴʟʏ ᴡᴏʀᴋs ɪɴ ɢʀᴏᴜᴘs)
/ᴄᴏʟʟᴇᴄᴛɪᴏɴ: Tᴏ sᴇᴇ Yᴏᴜʀ Cᴏʟʟᴇᴄᴛɪᴏɴ
/ᴛᴏᴘɢʀᴏᴜᴘs : Sᴇᴇ Tᴏᴘ Gʀᴏᴜᴘs.. Pᴘʟ Gᴜᴇssᴇs Mᴏsᴛ ɪɴ ᴛʜᴀᴛ Gʀᴏᴜᴘs
/ᴛᴏᴘ: Tᴏᴏ Sᴇᴇ Tᴏᴘ Usᴇʀs
/ᴄᴛᴏᴘ : Yᴏᴜʀ CʜᴀᴛTᴏᴘ
/ᴄʜᴀɴɢᴇᴛɪᴍᴇ: Cʜᴀɴɢᴇ Cʜᴀʀᴀᴄᴛᴇʀ ᴀᴘᴘᴇᴀʀ ᴛɪᴍᴇ (ᴏɴʟʏ ᴡᴏʀᴋs ɪɴ Gʀᴏᴜᴘs)
"""
